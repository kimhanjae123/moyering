    ...
    return (
        <div className="class-info-box">
            ...
            <div className="form-section">
                <label className="warning-info-label"><span className="required-text-dot">*</span>신청 시 유의사항</label>
                <textarea
                    className="warning-info-textarea"
                    value={warningInfo}
            ...
            {/* 환불 규정 */}
            <div className="form-section">
                <label className="refund-policy-label"><span className="required-text-dot">*</span>환불 규정</label>
                <textarea
                    className="refund-policy-textarea"
